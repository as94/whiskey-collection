export const whiskeyCategoryDescriptions = {
  Bourbon: `Bourbon is an iconic American whiskey, crafted with at least 51% corn and aged in charred oak barrels. Known for its sweet and mellow flavor profile, it features notes of caramel, vanilla, and rich complexity.`,
  ...
  'American Whiskey': `American whiskey is a type of distilled spirit made from a mash of
  ...
  'Scotch Whisky': `Scotch whisky is a popular alcoholic beverage made from malted
  ...
  'Canadian Whisky': `Canadian whisky is a blended alcoholic beverage made primarily from
  ...
  'White Whiskey Moonshine': `Moonshine whiskey is an illicitly produced and unaged spirit that embodies the raw and intense character of homemade distillation. Crafted in small batches, typically from corn, it delivers a fiery kick and rustic flavor profile, reflecting its storied history of clandestine production.`,
  'Irish Whiskey': `Irish whiskey is a popular alcoholic beverage made from a mash of
  ...
  whiskey.`,
  'Japanese Whisky': `Japanese whiskey is a type of alcoholic beverage made in Japan,
  ...
  'Single Malt Whiskey': `Single malt whiskey is a prestigious and exceptional style of whiskey made exclusively from malted barley at a single distillery. Its production involves carefully selected ingredients, meticulous fermentation, and aging processes, resulting in a unique and sought-after spirit.`,
};
